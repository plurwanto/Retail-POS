<?php
class downloadD extends Controller {//update stock berdasarkan mutasi
    ...
    function index(){
    	...
    	if($sign=="Y")
		{
	        ...
	        $this->load->view('proses/upload_data/upload', $data);
	    }
		else{
...
{
//    echo "OK"; die();
  $eksekusi=$this->downloadd_model->upload_csv_id();
  if($eksekusi==true)
  {
