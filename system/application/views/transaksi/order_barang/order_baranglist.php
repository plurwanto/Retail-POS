...
<script language="javascript">
	...
	{
		url="index.php/transaksi/order_barang/cetak/"+escape(kode);
	...
	<tr>
		...
		<td>
			<select size="1" height="1" name ="searchby" id ="searchby" onchange="gantiSearch()">
				...
				<option value="TglDokumen">Tglorder</option>
...
?>
		...
		<?php
                            ...
                            echo "<img src='".base_url()."public/images/accept.png' border = '0' title = 'Telah DiKonfirmasi'/>";
                        }
		?>
		</td>
<?php } ?>
		...
		<td nowrap><?=stripslashes($data[$a]['Nama']);?></td>
                <td nowrap align="right"><?=$data[$a]['CountQty'];?></td>
