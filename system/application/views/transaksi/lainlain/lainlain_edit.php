<div class="widget-box">
    <div class="widget-header">
        <h5 class="widget-title">Edit Terima/Keluar Lain</h5>
    </div>
            ...
            <div class="widget-main">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="tgl" name="tgl" readonly='readonly' value="<?=$header->TglDokumen;?>" class="form-control input-sm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 err">
                        <select id="tipe_show" name="tipe_show" class="form-control input-sm" disabled="disabled">
                            <option value="">Pilih</option>
                            <option <?php echo ($header->Tipe == "M" ? " selected " : "")?> value="M">PENERIMAAN</option>
                            <option <?php echo ($header->Tipe == "K" ? " selected " : "")?> value="K">PENGELUARAN</option>
                        </select>
                        <input type="hidden" id="tipe" name="tipe" value="<?=$header->Tipe;?>" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 err">
                        <input type="text" id="ket" name="ket" class="form-control input-sm" maxlength="30" value="<?=$header->Keterangan;?>">
                    </div>
                </div>
