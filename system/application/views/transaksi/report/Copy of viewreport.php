...
<body>
  ...
  <tr>
    ...
    <td colspan="3"><input type="radio" id="pilihan" name="pilihan" value="detail" <?=$aa?>>Detail&nbsp;
  ...
  <tr>
    ...
    <td><input type="text" name="tgl_1" id="tgl_1" size="15" value="<?=$tglawal?>"> 
	...
	<td><b>s/d</b></td>
    <td><input type="text" name="tgl_2" id="tgl_2" size="15" value="<?=$tglskrng?>"> 
...
<fieldset><legend>Hasil Pencarian</legend>
  <table border="1" class="table_report" cellpadding="2" cellspacing="0">
    <tr> 
      ...
      <th colspan="4" nowrap>Customer</th>
...
?>
    <tr> 
	  ...
	  <td align="center" nowrap> 
        <?
		if($temp_so8==$detail[$a]['NoStruk']){

		}
		else{
			echo $detail[$a]['Gender'];
			$temp_so8=$detail[$a]['NoStruk'];
		}?>
      </td>
	  <td align="center" nowrap> 
        <?
		if($temp_so9==$detail[$a]['NoStruk']){

		}
		else{
			echo $detail[$a]['umur'];
			$temp_so9=$detail[$a]['NoStruk'];
		}?>
      </td>
      <td align="right" nowrap><?=$detail[$a]['PCode'];?></td>
      <td align="center" nowrap><?=$detail[$a]['NamaStruk'];?></td>
...
?>
 <tr>
 	...
 	<td align="center" nowrap><?=$barang[$a]['NamaLengkap'];?></td>
