...
<form method='post' name="terima" id="terima" action='<?=base_url();?>index.php/transaksi/terima_counter/save_new' onsubmit="return false">
	<table align = 'center' >
		<tr>
			<td>
			<fieldset class="disableMe">
			<legend class="legendStyle">Add Terima Counter</legend>
			...
			echo $mylib->write_textbox("Tanggal","tgl",$aplikasi->TglTrans,"10","10","readonly='readonly'","text",$gantikursor,"1");
                        echo $mylib->write_combo("Counter","counter",$mcounter,"","KdCounter","Nama",$gantikursor,"onchange=\"simpanKontak();\"","ya");
					...
					<td>Total</td>
                            ...
                            <tbody id="dataTable">
                                <tr id="dataTable">
                                    ...
                                    <td nowrap><input type="text" id="ttl1" name="ttl[]" size="15" readonly="readonly" ></td>
                                </tr>
                            </tbody>
			</table>
			</fieldset>
		...
		<tr>
			<td nowrap>
				...
				<input type='hidden' id="sbr" name="sbr" value="M">
				<input type='hidden' value='<?=base_url()?>' id="baseurl" name="baseurl">
				<input type='button' value='Save' onclick="saveAll();"/>
				<input type="button" value="Back" ONCLICK =parent.location="<?=base_url();?>index.php/transaksi/kirim_counter/" />
			</td>
		</tr>
	</table>
</form>
