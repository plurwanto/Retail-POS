...
<div class="widget-box">
    <div class="widget-header">
        <h5 class="widget-title">Edit Opname</h5>
    </div>
            ...
            <div class="widget-main">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 err">
                        <input type="text" id="ket" name="ket" class="form-control input-sm" value="<?=$header->Keterangan;?>" maxlength="30">
                    </div>
                </div>
                    ...
                    <div class='col-xs-10 col-sm-10 col-md-10 col-lg-10'>
                        <table class="table table-bordered table-condensed" id="detail">
                            ...
                            <tbody>
                                <tr id="no_0">
                                    <td></td>
                                    <td><input type="text" data-type="PCode" name="itemNo_0" id="itemNo_0" class="form-control autocomplete_txt input-sm" autocomplete="off" placeholder="ketik kode/nama brg"></td>
                                    ...
                                    <td><input type="text" name="qty_Opname_0" id="qty_Opname_0" class="form-control text-right input-sm" autocomplete="off" onkeyup="sum_selisih();" title="tekan enter untuk menyimpan" data-rel="tooltip"></td>
