<div class="widget-box">
    <div class="widget-header">
        <h5 class="widget-title">Edit Terima Barang</h5>
    </div>
        ...
        <form method='post' name="terimabarang" id="terimabarang" action="<?php echo base_url();?>index.php/transaksi/penerimaan_barang/ajax_save_proses" class="form-horizontal">
            <div class="widget-main">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" size="10" name="nodok" id="nodok" value="<?=$header->NoDokumen;?>" readonly='readonly' class="form-control input-sm"/>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="tgl" name="tgl" readonly='readonly' value="<?=$mylib->ubah_tanggal($header->TglDokumen);?>" class="form-control input-sm">
                    ...
                    <div class="col-sm-2">
                        <div class="input-medium">
                            <div class="input-group">
                                <input type="text" id="tglterima" name="tglterima" value="<?=$mylib->ubah_tanggal($header->TglTerima);?>" class="input-medium date-picker input-sm" data-date-format="dd-mm-yyyy">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input type="text" id="noorder" name="noorder" value="<?=$header->NoOrder;?>" class="form-control input-sm" maxlength="30">
                            <span class="input-group-btn">
                                <button id="btnorder" disabled class="btn btn-xs btn-info"><i class="fa fa-folder"></i></button>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 err">
                        <input type="text" id="nopo" name="nopo" value="<?=$header->NoPO;?>" class="form-control input-sm" maxlength="30">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-2 err">
                        <select id="supplier" name="supplier" class="form-control input-sm">
                            ...
                            <?php foreach ($mkontak as $value) {
                                ?>
                                <option <?php
                                if ($value['KdSupplier'] == $header->KdSupplier) {
                                    echo 'selected';
                                }
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 err">
                        <input type="text" id="ket" name="ket" value="<?=$header->Keterangan;?>" class="form-control input-sm" maxlength="30">
                    </div>
                </div>
