<a href="<?=base_url()?>index.php/transaksi/<?=$url2?>">
    <img style="border:0px" src="<?=base_url()?>public/images/kepson.png">
</a>
<?php
...
<table border="0">
	...
	<td colspan="<?=$colspan_line?>" nowrap>
		...
		<?php
			...
			$printlib->print_footeropname(count($judul_detail),(int)$a+1,$tot_hal,$bayar);
		?>
		</table>
	</td>
	</tr>
