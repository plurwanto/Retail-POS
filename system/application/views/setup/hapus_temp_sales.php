...
function doThis()
{
	x=confirm("Apakah anda yakin akan menghapus temporary sales ?");
	if(x){
...
<form method="post" name="backup" id="backup" action="<?=base_url()?>index.php/setup/del_temp/doThis">
<table align = 'center' width="50%">
	<tr>
		<td align="center">
		<fieldset class="disableMe">
		<legend class="legendStyle">Hapus Temporay Sales</legend>
