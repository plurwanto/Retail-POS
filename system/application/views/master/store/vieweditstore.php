...
<table align = 'center'>
<form method='post' name="store" id="store" action='<?=base_url();?>index.php/master/store/save_store'>
<?php
	$mylib = new globallib();
	echo $mylib->write_textbox("Kode Store","kode",$id,"10","6","readonly","text",$gantikursor,"5");
