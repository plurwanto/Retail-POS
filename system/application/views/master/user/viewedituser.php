<div class="widget-box">
    <div class="widget-header">
        <h5 class="widget-title">Edit User</h5>
    </div>
    <div class="widget-body">
        <form method='post' name="form1" id="form1" action='<?=base_url();?>index.php/master/user/save_user' class="form-horizontal">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group input-group-sm">
                            ...
                            <input type='text' id='user' name='kode' readonly="readonly" class="form-control input-sm" value="<?=$viewuser->Id;?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-3 err">
                        <input type='text' id='nama' name='nama' class="form-control input-sm" value="<?=$viewuser->UserName;?>"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-3 err">
                        <select id="master" name="master" class="form-control input-sm">
                            ...
                            foreach ($master as $value) {
                                echo "<option " . ($viewuser->UserLevel == $value['UserLevelID'] ? "selected " : "") . "value='" . $value['UserLevelID'] . "'>" . $value['UserLevelName'] . "</option>";
                            }
                            ?>
                        </select>
                    </div>
