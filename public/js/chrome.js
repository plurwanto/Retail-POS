...
downarrowpointer: ["/public/images/arrow-down.gif", 11,7], //path to "down arrow" image that gets added to main menu items (last 2 parameters should be width/height of img)
rightarrowpointer: ["/public/images/arrow-right.gif", 12,12], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
hideinterval: 100, //delay in milliseconds before entire menu disappears onmouseout.
revealanimate: [true, 3], //enable sliding animation when revealing sub menus? [Bool, int_steps] (steps: 5-100, where lower=faster)
...
getUrl:function(url)
{
	this.downarrowpointer = [url + this.downarrowpointer[0],this.downarrowpointer[1],this.downarrowpointer[2]];
	this.rightarrowpointer = [url + this.rightarrowpointer[0],this.rightarrowpointer[1],this.rightarrowpointer[2]];
